...
# probably get the patient id from session
...
class PatientRecord(Resource):
    ...
    def post(self):
        ...
        data = request.json
        return patient_records_service.save_intial_test(data["patient_id"], data)
...
class PatientRecord(Resource):
    ...
    def get(self, test_id):
        """get a test"""
        return patient_records_service.get_a_test(test_id=test_id)
